...
ruido_sal_y_pimienta = generar_ruido_sal_y_pimienta(senal, fs, 0.5, -5)
espectro_ruido = np.abs(np.fft.fft(ruido_sal_y_pimienta))[0:int(N/2)]

senal_ruidosa = senal + ruido_sal_y_pimienta
...
axes[1][0].plot(t, ruido_sal_y_pimienta)
